...
class _HomeState extends State<Home> {
  ...
  Future<void> uploadFileImage() async {
    ...
    String uploadEndpoint =
        "https://a102-125-163-222-221.ngrok-free.app//uploadFileAndroid"; // Ganti dengan alamat server Flask yang sesuai
    Dio dio = Dio();
  ...
  Future<void> sendJsonToFlask() async {
    ...
    String apiUrl =
        "https://a102-125-163-222-221.ngrok-free.app//predictAndroid";
    Dio dio = Dio();
